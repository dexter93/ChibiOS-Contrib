...
#define __USBHW_H__
	...
	#define	REMOTE_WAKEUP_IO_P0_BIT		0
	#define	REMOTE_WAKEUP_IO_P1_BIT		0
	#define	REMOTE_WAKEUP_IO_P2_BIT		BIT_0
	#define	REMOTE_WAKEUP_IO_P3_BIT		0
	...
	#define	EP5_NAK_IE							DISABLE
	#define	EP6_NAK_IE							DISABLE
